...
void
MCP23017::writeRegister(MCP23017Register reg, uint8_t value)
{
...
void
MCP23017::writeRegister(MCP23017Register reg, uint8_t portA, uint8_t portB)
{
  _bus->beginTransmission(_deviceAddr);
  _bus->write(static_cast<uint8_t>(reg));
  _bus->write(portA);
...
uint8_t
MCP23017::readRegister(MCP23017Register reg)
{
  _bus->beginTransmission(_deviceAddr);
  _bus->write(static_cast<uint8_t>(reg));
  _bus->endTransmission();
...
void
MCP23017::readRegister(MCP23017Register reg, uint8_t& portA, uint8_t& portB)
{
  _bus->beginTransmission(_deviceAddr);
  _bus->write(static_cast<uint8_t>(reg));
  _bus->endTransmission();
...
void
MCP23017::begin(uint8_t address)
{
  _deviceAddr = address;
  begin();
}
...
void
MCP23017::portMode(MCP23017Port port, uint8_t directions, uint8_t pullups, uint8_t inverted)
{
...
void
MCP23017::digitalWrite(uint8_t pin, uint8_t state)
{
...
void
MCP23017::writePort(MCP23017Port port, uint8_t value)
{
...
uint8_t
MCP23017::readPort(MCP23017Port port)
{
...
void
MCP23017::interruptMode(MCP23017InterruptMode intMode)
{
...
void
MCP23017::interrupt(MCP23017Port port, uint8_t mode)
{
...
void
MCP23017::interruptedBy(uint8_t& portA, uint8_t& portB)
{
...
void
MCP23017::disableInterrupt(MCP23017Port port)
{
...
void
MCP23017::clearInterrupts(uint8_t& portA, uint8_t& portB)
{
